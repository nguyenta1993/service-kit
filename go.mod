...
require (
	...
	github.com/etf1/opentelemetry-go-contrib/instrumentation/github.com/confluentinc/confluent-kafka-go/otelconfluent v1.0.0 // indirect
	...
	github.com/uptrace/opentelemetry-go-extra/otelplay v0.1.17 // indirect
